function Fire(){
	...
	this.configure = function(){
		...
		for (var i = 0; i < _this.imageUrls.length; i++) {
			...
			img.src = "/img/exp/fire/"+_this.imageUrls[i];
		};
	...
	this.bindEvents = function(){
		...
		document.addEventListener("mousemove", function(e){
			_this.rotationSpeed = ((e.pageX  - _this.canvas.offsetParent.offsetLeft) - _this.canvas.width / 2) * 0.00005;
		});
	}
