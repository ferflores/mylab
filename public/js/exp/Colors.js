function Colors(){
	...
	this.configure = function(){
		require(["/js/classes/Utils/Hex.js","/js/classes/Vectors/Vector.js","/js/classes/Particles/Particle.js"], function(ColorUtil) {
			_this.createCircle();
			_this.main();
		});
	}
	...
	this.createCircle = function(){
		...
		circle.particle = Particle.create(_this.cx, _this.cy, 5, _this.currentAngle,0.01);
